...
export const scenarios: Scenario[] = [
  {
    ...
    highlights: [
      '上半年薪資只報 70%，下半年報 100%',
      '上半年可選 partial non-resident（海外資產免報）',
      '下半年起所有海外資產都要申報 Box 3',
    ],
    warnings: [
      '很可能需要補稅（下半年預扣稅率可能不夠）',
  ...
  },
  {
    ...
    description: '30% ruling 在年中到期，有自住房。複雜但有新的扣除機會。',
    rulingStatus: '30percent-transition',
    housingStatus: 'own',
    highlights: [
      '上半年薪資只報 70%，下半年報 100%',
      '下半年起可以使用 hypotheekrenteaftrek（房貸利息扣除）',
      '房貸利息扣除通常能大幅減稅',
    ],
    warnings: [
      '要計算 eigenwoningforfait（自住房虛擬收入）',
      '上半年如果選了 partial non-resident，房貸利息扣除會受限',
      'WOZ 值會影響你的虛擬收入金額',
    ],
  },
  {
    ...
    description: '享有完整的 30% ruling 優惠，目前租屋。最簡單的情境。',
    rulingStatus: '30percent',
    housingStatus: 'rent',
    highlights: [
      '只需報 70% 的薪資',
      '可選 partial non-resident，海外資產免報',
      '報稅最簡單的情境',
    ],
    warnings: [
      '確認 jaaropgave 上有正確反映 30% ruling',
      '注意 30% ruling 的到期日，提前規劃',
    ],
  },
  {
    id: 'none-rent',
  ...
  },
  {
    ...
    description: '同時有 30% ruling 和自住房。需要在 partial non-resident 和房貸利息扣除之間選擇。',
    rulingStatus: '30percent',
    housingStatus: 'own',
    highlights: [
      '只需報 70% 的薪資',
      '可以使用 hypotheekrenteaftrek（但不能同時選 partial non-resident）',
    ],
    warnings: [
      '需要計算哪個更划算：partial non-resident vs hypotheekrenteaftrek',
      '通常房貸金額大的話，放棄 partial non-resident 選房貸利息扣除更划算',
      '兩者不能兼得！',
    ],
  },
]
